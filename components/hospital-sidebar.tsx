...
import { LayoutDashboard, Users, Activity, Menu, X, Building2, LogOut, FileText, Calendar } from "lucide-react"
import { cn } from "@/lib/utils"

const navigation = [
  { name: "Dashboard", href: "/dashboard/hospital", icon: LayoutDashboard },
  { name: "Appointments", href: "/dashboard/hospital/appointments", icon: Calendar },
